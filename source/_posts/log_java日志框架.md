...
![image](https://github.com/ZephXu07/IMG/raw/master/concrete-bindings.png)
...
![image](https://github.com/ZephXu07/IMG/raw/master/loga.png)

然后都是继承Category这个类，实际上主要的方法实现都在这里，下面分别是log4j包和log4j-over-slf4j包中的Category：

![image](https://github.com/ZephXu07/IMG/raw/master/logb.png)

![image](https://github.com/ZephXu07/IMG/raw/master/logc.png)

从图中可以看出log4j就是自己在写日志，而后者则委托给了slf4j。

这是slf官网的图。

![image](https://github.com/ZephXu07/IMG/raw/master/legacy.png)
